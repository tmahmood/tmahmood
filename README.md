...
[To convert large excel files to sqlite database or csv?](https://www.upwork.com/services/product/development-it-script-to-automate-converting-large-excel-files-to-sqlite-database-or-csv-1958535276284793980?ref=project_share)

Or,

[Convert PDF files to a specific format, or able to extract text](https://www.upwork.com/services/product/development-it-a-program-to-process-pdf-file-and-convert-it-to-a-specific-format-or-pdf-1636719710874423296?ref=project_share)
...
But there are many more projects that I'm working on that are on my repositories.
